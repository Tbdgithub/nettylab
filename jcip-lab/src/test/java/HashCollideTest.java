...
public class HashCollideTest {
     ...
     *            hash算法中采用的乘积值 (hash' = hash * mulBase + char[i])
     */
    public HashCollideTest(int collideCharBase, int collideCharLength, int mulBase) {
    ...
    public static void main(String[] args) {
        ...
        HashCollideTest collide = new HashCollideTest(85, 7, 31);
        for (int i = 0; i < 10000; ++i) {
            String a = collide.randomString(57);
            String b = collide.collide(a, 987654321);
            System.out.println(b);
            if (b.hashCode() != 987654321) {
        ...
        System.out.println(x.hashCode() + " equals " + y.hashCode());
